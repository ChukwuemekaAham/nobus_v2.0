...
const docsfilters = [
  {
    ...
    options: [
      ...
      { value: "FCS Dedicated Hosting", href: "#" },
      { value: "Flexible Block Storage", href: "#" },
      { value: "FBS Snapshots", href: "#" },
      { value: "Nobus FastTransit", href: "#" },
      { value: "Flexible Object Storage", href: "#" },
      { value: "Nobus Cloud Backup", href: "#" },
      { value: "Sophos XG Firewall", href: "#" },
      { value: "Fortigate", href: "#" },
      { value: "Acronis Cyber Protect", href: "#" },
      { value: "Nobus Domains and DNS", href: "#" },
      { value: "Nobus Cloud Container", href: "#" },
      { value: "Datacenter as a Service", href: "#" },
      { value: "FCS Autoscaling", href: "#" },
      { value: "Virtual Private Network", href: "#" },
      { value: "Network Firewalls", href: "#" },
      { value: "Networking", href: "#" },
      { value: "Security Groups", href: "#" },
      { value: "Floating IPs", href: "#" },
      { value: "Flexible Load Balancing", href: "#" },
      { value: "Database Migration", href: "#" },
      { value: "Database Services", href: "#" },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "Set up Site-to-Site VPN in Nobus Cloud using LibreSwan",
        href: "#",
      },
      { value: "Configure OpenVPN Client with PfSense", href: "#" },
      { value: "Configure HaProxy Loadbalancing with PfSense", href: "#" },
      ...
      { value: "Mount additional volumes", href: "#" },
      {
        value: "Provision resource on nobus cloud using terraform IAC",
        href: "#",
      },
      ...
      { value: "Configure WHM CPanel on nobus instance", href: "#" },
    ],
  },
  {
    id: "tutorials",
