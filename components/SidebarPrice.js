...
const pricefilters = [
    {
      name: "Flexible Compute Instance",
      href: "/pricing/fcs",
      options: [
        { value: "Instance Pricing", href: "/pricing/fcs" },
        { value: "Standard Instance", href: "#" },
        { value: "Compute Optimized Instance", href: "#" },
        { value: "Memory Optimized Instance", href: "#" },
    ...
    href: "/pricing/fbs",
    options: [
        { value: "Block Storage Pricing", href: "/pricing/fbs" },
        { value: "HDD", href: "#" },
        { value: "SSD", href: "#" },
  ...
  function SidebarPrice({ open, setOpen }) {
                            ...
                            >
                                ...
                                <>
                                  <Link href={section.href} className={`${router.pathname == section.href ? `group` : ""}`}>
                                    ...
                                    <div className="space-y-2 pt-4 h-[400px] overflow-visible overflow-y-scroll">
