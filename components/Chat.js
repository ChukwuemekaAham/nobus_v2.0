            ...
            <Popover className="flex">
              ...
              <>
                ...
                >
                  ...
                  <ChatAlt2Icon
                    className={classNames(
                      open ? 'group-hover:scale-125' : 'h-6 w-6 text-md font-medium text-white group-hover:scale-125',
                      'h-6 w-6'
                    )}
                    aria-hidden="true"
                  />
                ...
                >
                  <Popover.Panel className="absolute rounded-2xl sm:right-20 z-10 top-10 sm:top-20 w-screen max-w-md -translate-x-2/5 transform px-2 sm:px-0"
                    style={{
