...
import { UserIcon, MinusIcon, PlusIcon, SpeakerphoneIcon, GlobeAltIcon, MenuAlt3Icon, LightBulbIcon, BookOpenIcon, PlayIcon, PhoneIcon, ChartBarIcon, CogIcon, SearchIcon, ShoppingBagIcon, XIcon, CalendarIcon, ShieldCheckIcon, ChevronDownIcon } from '@heroicons/react/outline'
              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="space-y-6 border-t border-gray-200 py-6 px-4">
                  {navigation.pages.map((page) => (
                    <div key={page.name} className="flow-root group">
                      <a href={page.href} className="-m-2 block p-2 font-medium text-gray-900 group-hover:underline group-hover:bg-gray-100 ">
                        {page.name}
                      </a>
                    </div>
                  ))}
                ...
                <div className="space-y-6 border-t border-gray-200 py-6 px-4">
                  <div className="flow-root group">
                    <a href="https://dashboard.nobus.io" className="-m-2 text-center block button-outline p-2 font-medium text-gray-900 group-hover:underline group-hover:bg-gray-100 ">
                      Sign in
                    </a>
                  </div>
                      ...
                      <Popover className="flex">
                        ...
                        <>
                          ...
                          >
                            ...
                            <ChevronDownIcon
                              className={classNames(
                                open ? 'text-gray-600 rotate-180 tracking-widest transition duration-100 transform hover:scale-125' : 'text-gray-400 hover:scale-125 transition duration-100 transform tracking-widest',
