...
function index() {
  return (
    ...
    <div className='top-0 grid gap-y-10'>
        <div className='flex-col px-20 text-left' style={{
                ...
                <div className="py-20 lg:pt-40 text-black">
                    ...
                    <p className="text-sm sm:text-md lg:text-2xl font-md tracking-wide leading-relaxed pb-4">
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6 my-10">
          ...
          <div class="mt-5 md:col-span-2 md:mt-0 " >
            <div className='grid grid-cols-1 gap-y-10 gap-x-8 mx-10 sm:mx-20'>                  
              {blogCard.map((blog) => (
                <div key={blog.id} className="group relative bg-white border shadow hover:scale-102 hover:shadow-xl">
                  ...
                  <div className="py-5 px-4">
                    ...
                    <p className="text-[15px] tracking-wide leading-relaxed py-5 text-gray-800">{blog.desc}</p>
                  </div>
          ...
          <div class="md:col-span-1">
            <div className='mx-10 sm:mx-20 md:mx-2 pb-8'>
              <div>
                <h5 className="text-left tracking-wide font-semibold lg:mt-0">Recent Posts</h5>
                <hr className="max-w-[50px] my-2 border border-red-400" />
                <div className="flex-col mt-10 space-x-2">
                  <div className="flow-root ">
                    <ul role="grid" className="-my-6 grid grid-cols-1 gap-y-6 gap-x-8 ">
                      {features.map((feature) => (
                        <li key={feature.id} className="flex py-3 hover:bg-gray-100 border-b border-gray-200">
              ...
              <div className='mt-20'>
                ...
                <div className="flex-col mt-5 space-x-3">
                  <div className="flow-root">
                    <ul role="grid" className="grid grid-cols-3 gap-y-2 gap-x-2">
                      {Tags.map((tag) => (
