  ...
  return (
    ...
    <div className='top-0 grid gap-y-10'>
        ...
        <div className='p-20'>
          ...
          <p className='pb-5'>Nobus offers standard compute services that allows you to develop, deploy, run, and
           scale your applications and workloads in a secure, powerful, and progressive compute cloud.
          </p> 
            
           <h4 className='font-semibold text-2xl'>Nobus Compute as a Choice</h4>
           
           <p className='py-2'>You are safe with Nobus, as we continue to facilitate speed and efficiency on our platform. We progressively try to make our plarform support any workload and business need.</p> 
            <div className='pt-10'>
                <div className='grid grid-cols-1 gap-y-8 gap-x-8 md:grid-cols-2 lg:grid-cols-3'>                  
                    {cardData?.map((item) => (
                        <div
                        className="p-5 bg-gray-100 flex flex-col space-x-4 text-left shadow-3xl border group"
                        >  
                           
                            <div className="py-5">
                                <h1 className="pb-3 text-2xl tracking-wide leading-relaxed font-semibold text-gray-800">{item.title}</h1>
                                <p className="text-base text-gray-700 text-justify tracking-tight leading-relaxed">{item.description}</p>
                            </div>
