  ...
  const registerUser = async (data: RegisterInput) => {
    try {
      ...
      if (response.status === 201) {
        toast.success(
          "An email with verification code has been sent to your mail box",
          {
                ...
                <form onSubmit={handleSubmit(onSubmitHandler)} className="px-4">
                  <div className="overflow-hidden sm:rounded-md">
                      ...
                      <div className="grid grid-cols-4 gap-x-2 gap-y-5">
                          ...
                          >
                            ...
                            <div
                              ...
                              onClick={() =>
                                setConfirm({
                                  ...confirm,
                                  showConfirm_Password: !confirm.showConfirm_Password,
                                })
                              }
                            >
                              {confirm.showConfirm_Password ? (
                       ...
                       `}
                          ...
                          >
                            ...
                            <option value="Quarterly Billing">
                              Quarterly (every 3 month)
                            </option>
                          </select>
                        </div>
                        {errors.company?.billing && (
                          <span className="text-red-500 text-xs pt-1 block">
                            {errors.company.billing.message}
                          </span>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex justify-center pb-5">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        >
                          I accept the
                          <Link
                            className="text-blue-500 font-medium hover:underline pl-2"
                            target="_blank"
                    ...
                    <p className="flex justify-center pb-5 text-sm font-medium text-gray-500">
                      <span>Filled this form already?</span>
                      <a
                        href="/registration/continue"
                        className="font-medium pl-2 text-blue-500 hover:underline"
                      >
