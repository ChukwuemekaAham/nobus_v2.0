...
function index() {
  ...
  return (
    <section className="overflow-hidden">
      <Head>
        <title> Pricing - Nobus Domains and DNS Services </title>
                    ...
                    <section id="overview" className="mx-auto text-justify">
                      <div className="">
                        <p className="">
                          ...
                          NCS, Our cloud customers can now provide an extra
                          layer of backup &amp; Cyber security for their
                          applications at a fractional monthly cost. On-Premise
                          customers, and customers hosting their applications
                          with other 3rd party cloud providers such as AWS,
                          Azure, GCP or VMWare-Based hypervisors can now backup
                          and protect their applications and critical user data
                          on Nobus platform
                        </p>
                        ...
                        <div className="pb-4 space-y-2">
                          <p>
                            ...
                            workloads (Cloud &amp; On-premise, Nobus cloud or
                            3rd party cloud)
                          </p>
                          ...
                          <p>
                            <b>6.</b> Single view for management of all
                            Protected workloads
                          </p>

                          <p>
                            <b>7.</b> NDPS cuts your Cyber protection costs by
                            up to 50%, boosts your monthly recurring revenue,
                            while delivering best in className Cyber protection
                            for your applications and data.
                          </p>
                        </div>
                        <p className="">
                          To protect business-critical data, backup is not
                          enough – clients need the integrated approach of cyber
                          protection. Paired with Nobus Cloud Backup, the
                          Advanced Backup pack enables you to extend the cloud
                          backup capabilities your clients require to
                          proactively protect their data. Available in
                          consumption-based or per-workload licensing models,
                          you can easily minimize data loss across your clients’
                          infrastructure and workloads with the best-in-breed
                          backup and recovery technology that is enhanced with
                          cyber protection. See the{" "}
                          <a
