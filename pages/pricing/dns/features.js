            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4"> 
              ...
              <Tab.Panel data-headlessui-state="selected">
                ...
                <p>
                    ...
                    various kind of workloads thus, we are keen to deliver the networking 
                    strenght required to run any workload in the cloud ensuring security, 
                    availability, manageability, performance, and wide coverage.
                    </p>
                </section>
              </Tab.Panel>
              <Tab.Panel className="mx-auto text-center justify-center max-w-sm my-auto">
