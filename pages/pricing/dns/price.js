                  ...
                  <section id="price" className="mx-auto text-justify">
                    ...
                    <div className="p-4 border border-green-400 bg-green-100 rounded-md">
                      <p className="text-md textgray-800">
                        Nobus offers free backup of your entire infrastructure for now.
                        This is subject to the terms and conditions of Nobus agreement with customers
                        and can be reviewed in the future.
                      </p>
