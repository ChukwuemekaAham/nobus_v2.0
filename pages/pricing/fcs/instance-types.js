...
function index() {
  ...
  const flavors = ["Standard Flavors", "Compute Optimized", "Storage Optimized Flavors","Memory Optimized Flavors"]
          ...
          <Tab.Group defaultIndex={3}>
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4"> 
              ...
              <Tab.Panel data-headlessui-state="selected">
                <section id="instance-types" className="mx-auto text-justify">
                  <h2 className="pb-5 text-2xl font-semibold text-[#232f3e]"> FCS Instance Flavors</h2>
                  <p>
                   Nobus FCS gives you a variety of instance flavors ( including different 
                   combinations of CPU, storage, memory and networking capacity ) organized 
                   and optimized for several use cases and scheduled workload.
                  </p>
                  <div className="py-10">
                  <Tab.Group>
                    ...
                    <Tab.Panels className="flex my-5 bg-white/5 transition p-10 w-full border rounded-3xl h-[500px] overflow-y-scroll scrollbar-hide">
                      <Tab.Panel>
                        ...
                        <h6 className="pb-5 text-xl font-semibold text-[#232f3e]">Features:</h6> 
                        <ul className="pl-5 list-disc"> 
                        <li>Support for Extensive and Valuable Networking </li> 
                                  ...
                                  <tbody className="bg-white divide-y divide-gray-200">
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.1.1.10.l</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.2.2.10.l</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.1.1.20.l</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">1</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.1.2.20.l</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">1</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.2.2.40.l</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">2</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.2.4.40.l</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">2</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.4.4.40.l</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">4</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.2.8.60.lw</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">2</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.4.8.60.lw</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">4</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.4.16.60.lw</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">4</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.4.32.80.lw</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">4</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.8.16.80.lw</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">8</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.8.32.80.lw</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">8</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.8.64.80.lw</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">8</div>
                                      </td>
                                    ...
                                    <tr>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">si.16.64.80.lw</div>
                                      </td>
                                      <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="text-sm text-gray-900">16</div>
                                      </td>
                      ...
                      <Tab.Panel className="mx-auto text-center font-semibold text-2xl justify-center max-w-7xl my-auto">
                        <div >
                        FLAVOR COMING SOON
                        </div>
                      </Tab.Panel>
