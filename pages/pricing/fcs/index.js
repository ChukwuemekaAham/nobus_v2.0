                ...
                <Tab.Panels className="flex flex-col col-span-1 md:col-span-2 lg:col-span-3 py-10 md:py-20 md:pl-20 h-[600px] overflow-y-scroll scrollbar-hide">
                  <Tab.Panel>
                    <section id="overview" className="mx-auto text-justify">
                      ...
                      <p>
                        Nobus FCS allows creating Virtual Machines (VM)
                        on-demand. Customers can get running immediately with
                        pre-configured template Machine Image and generic images
                        of windows and linux distributions. Provide tools to
                        build failure resilient applications by launching
                        application instances. In separate Availability Zones
                        (Coming Soon).
                      </p>
                      <p className="pt-2">
                        Nobus FCS compute console provides you with complete
                        control of your computing resources and lets you run on
                        Nobus’s dependable computing environment thus, allowing
                        you to obtain and configure capacity with less conflict.
                        Nobus FCS reduces the time required to obtain and boot
                        new server instances to minutes, allowing you to quickly
                        scale capacity, both up and down, as your computing
                        requirements change. With Nobus FCS you to pay only for
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 ">
                        ...
                        <div className="">
                          ...
                          <p>
                            Nobus FCS environment is very reliable and permits a
                            quick set up of substitute instances, all running
                            within a trustworthy and stable network
                        ...
                        <div className="">
                          ...
                          <p>
                            You have complete control of your instances. You can
                            stop any instance while retaining the data on the
                            boot partition, and then subsequently restart the
                            same instance from the dashboard.
                          </p>
                        </div>
                        <div className="">
                          <h6 className="pb-2 text-lg font-semibold text-[#232f3e]">
                          ...
                          <p>
                            Choose from multiple operating systems, instance
                            types, and software packages. Optimized
                            configuration of memory, CPU, instance storage, and
                            partition size for your application and operating
                            system.
                          </p>
                        </div>
                        <div className="">
                          ...
                          <p>
                            The utmost priority at Nobus is cloud security. Our
                            customer can benefit from a secure and firm
                            networking functionality for their compute
                            resources.
                          </p>
                        </div>
                        <div className="">
                          ...
                          <p>
                            As a Nobus customer, payment for compute capacity
                            actually consumed is at a very cheap rate. You
                            accept payment in Nigerian Naira.
                          </p>
                        </div>
                        <div className="">
                          <h6 className="pb-2 text-lg font-semibold text-[#232f3e]">
