        ...
        <div className="w-full px-2  sm:px-0">
          <Tab.Group defaultIndex={3}>
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4"> 
              ...
              <Tab.Panel data-headlessui-state="selected">Content 4

              <section id="storage-types" className="mx-auto text-justify">
                    <p>
                      Nobus FBS allows creating Virtual Machines (VM) on-demand. Customers can get running immediately with pre-configured template Machine Image. Provide tools to build failure resilient applications by launching application instances. In separate Availability Zones (Coming Soon).
                    </p>
                    <p>
                    Nobus FBS simple web service interface provides you with complete control of your computing resources and lets you run on Nobus’s dependable computing environment thus, allowing you to obtain and configure capacity with less conflict. Nobus FCS reduces the time required to obtain and boot new server instances to minutes, allowing you to quickly scale capacity, both up and down, as your computing requirements change. With Nobus FCS you to pay only for capacity that you actually use.
                    </p>
