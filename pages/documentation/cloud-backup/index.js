...
function index() {
  return (
    <section>
      <title> Nobus | Nobus Cloud Backup </title>
      ...
      <div className="top-0 grid gap-y-10">
        ...
        <div id="cloud" className="flex-col px-10 py-10 lg:px-20">
          <p className="">
            Protect your mission critical Systems from Servers to
            desktops/Laptops with Nobus Cloud Backup (NCB). With NCS, Our cloud
            customers can now provide an extra layer of backup &amp; Cyber
        ...
        <div id="fos" className="flex-col px-10 py-10 lg:px-20">
          FOS Cloud Backup Solution
        </div>
      </div>
      <Footer />
    </section>
